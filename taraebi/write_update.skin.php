...
$allowed_write_types = array('tarae');
$current_write_type = '';
...
if ($w == 'u' && isset($_POST['wr_7_del']) && $_POST['wr_7_del'] == '1') {
    ...
    // 기존 wr_7 값 가져오기
    $old_wr_7 = sql_fetch("SELECT wr_7 FROM {$write_table} WHERE wr_id = '{$wr_id}'");
...
// 메모 전용 게시물은 커스텀 뷰로 이동하도록 리디렉션 주소를 필터링
