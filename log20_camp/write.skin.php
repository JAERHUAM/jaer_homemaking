...
if ($write_type) {
    $custom_skin_file = '';
    if ($write_type === 'scena') {
        $custom_skin_file = $board_skin_path . '/write.scena.skin.php';
    } elseif ($write_type === 'pclist') {
        $custom_skin_file = $board_skin_path . '/write.pclist.skin.php';
    ...
    <div class="log20_write_form">
        ...
        <dl class="log20_double_row">
            ...
            <dd>
                <div class="log20_field_row">
                    <div class="log20_field_block">
                        <label for="wr_4">룰</label>
                        <input type="text" name="wr_4" value="<?php echo isset($write['wr_4']) ? $write['wr_4'] : '' ?>" id="wr_4" class="frm_input full_input" size="50" maxlength="255" placeholder="룰을 입력하세요">
                    </div>
                    <div class="log20_field_block">
                        <label for="wr_5">GM</label>
                        <input type="text" name="wr_5" value="<?php echo isset($write['wr_5']) ? $write['wr_5'] : '' ?>" id="wr_5" class="frm_input full_input" size="50" maxlength="255" placeholder="GM을 입력하세요">
                    </div>
                </div>
            </dd>
        </dl>
        ...
        <dl>
            <dt><label for="wr_6">구성원</label></dt>
            <dd>
                <input type="text" name="wr_6" value="<?php echo isset($write['wr_6']) ? $write['wr_6'] : '' ?>" id="wr_6" class="frm_input full_input" size="50" maxlength="255" placeholder="구성원을 입력하세요">
            </dd>
        </dl>
